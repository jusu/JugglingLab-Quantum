...
public class EditView extends View {
	...
	public EditView(Dimension dim) {
		...
		this.jae = new AnimatorEdit(this);
	...
	public void restartView(JMLPattern p, AnimatorPrefs c)
		...
		if (p != null) {
			...
			/*
			 * if (pat.getNumberOfJugglers() > 1) { new_ladder = new
			 * PassLadderDiagram(pat, parent);
			 * ((PassLadderDiagram)new_ladder).setAnimator(jae); } else {
			 */
