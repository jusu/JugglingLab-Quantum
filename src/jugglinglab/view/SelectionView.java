...
public class SelectionView extends View {
	...
	public SelectionView(Dimension dim) {
		...
		final JPanel pleft = new JPanel() {
			public void paint(Graphics g) {
				...
				g.fillRect(x - 10, appHeight / 2 - fm.getHeight(), width + 20,
						2 * fm.getHeight());
				g.setColor(Color.black);
			...
			public void mouseReleased(MouseEvent me) {
				...
				try {
					...
					SwingUtilities.invokeLater(new Runnable() {
						public void run() {
							new ErrorDialog(SelectionView.this, jeu
									.getMessage());
						}
					});
	...
	public void restartView() throws JuggleExceptionUser,
	...
	public JMLPattern getPattern() {
		return ja[4].getPattern();
	}

	public boolean getPaused() {
		return ja[4].getPaused();
	}

	public void setPaused(boolean pause) {
		/*
		 * if (ja[4].message == null) for (int i = 0; i < 9; i++)
